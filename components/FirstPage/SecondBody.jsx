...
export default function SecondBody() {
  ...
  return (
    <div className="md:mt-32 container mx-auto">
      <div className="invisible md:visible md:z-10 md:container md:mx-auto ">
        {/* Direction */}
        ...
        <div className="mt-32 flex justify-between">
          <div className="bg-white py-14 px-14 pr-24 rounded-2xl justify-start">{/* General for 1st div */}
            ...
            <div>
              ...
              {/* 1st text */}
              <div className="flex">
                <Image className="w-7" src='/assets/tick.svg' width={500} height={500} /> <p className="leading-8 font-normal text-3xl  py-4">Проверка компетенций</p>
              </div>
            ...
            <div>
              {/* 2nd text */}
              <div className="flex">
                <Image className="w-7" src='/assets/tick.svg' width={500} height={500} />{" "}
            ...
            <div className="invisible md:visible bg-[#F1DF6F] relative rounded-xl">{/* General for 2nd div */}
